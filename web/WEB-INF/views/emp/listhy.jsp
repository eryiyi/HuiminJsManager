            ...
            <div class="box-content">
                <form class="form-inline">
                    <div class="form-group">
                        <select class="form-control" id="is_select">
                            <option value="">--选择会员状态--</option>
                            <option value="1" ${query.is_select=='1'?'selected':''}>到期一个月以上</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <select class="form-control" id="is_use">
                            <option value="">--选择是否到期--</option>
                            <option value="0" ${query.is_use=='0'?'selected':''}>已到期</option>
                            <option value="1" ${query.is_use=='1'?'selected':''}>未到期</option>
                        </select>
                    </div>
